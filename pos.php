...
<div class="container mx-auto py-12 px-6">
    ...
    <div class="bg-white p-6 rounded-lg shadow-lg h-96 overflow-y-auto relative">
        ...
        <div class="mb-4">
            ...
            <input type="text" id="customerName" value="Edward Ryan Raquidan" placeholder="Enter customer name" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
        </div>
