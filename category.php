...
<body class="bg-gray-100 p-2">
    <div class="container mx-auto px-2 md:px-4">
        ...
        <div class="flex flex-wrap justify-between items-center mb-4">
            <a href="inventory.php" class="bg-blue-500 text-white py-2 px-3 rounded hover:bg-blue-600 text-sm md:text-base">Back</a>
        </div>
...
function deleteProduct(productId) {
    if (confirm('Are you sure you want to delete this product?')) {
        ...
        const search = "<?php echo isset($_GET['search']) ? urlencode($_GET['search']) : ''; ?>";

        // Send delete request via AJAX instead of window.location.href
        const xhr = new XMLHttpRequest();
