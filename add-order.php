...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        foreach ($_POST['product_name'] as $index => $product_name) {
            ...
            // Ensure price is numeric before using number_format
        ...
        <div class="border p-6 bg-white rounded-md shadow-md">
            ...
            <form action="add-order.php" method="POST" id="customer-form">
                ...
                <div class="flex justify-center mt-4">
                    <button type="submit" class="w-full bg-gradient-to-r from-green-500 to-green-600 text-white py-3 rounded-md font-semibold text-center shadow-lg hover:from-green-600 hover:to-green-500 transform transition-all duration-300">
                        Place Order
                    </button>
                </div>
                ...
                <!-- Back Link -->
                <div class="flex justify-center mt-4">
                    <a href="javascript:history.back()" class="w-full bg-gradient-to-r from-red-500 to-red-600 text-white py-3 rounded-md font-semibold text-center shadow-lg hover:from-red-600 hover:to-red-500 transform transition-all duration-300">
                        Back
                    </a>
                </div>
            </form>
