...
--
-- Host: 127.0.0.1
-- Generation Time: May 15, 2025 at 10:37 AM
...
(350, 'Rina Balingit', 'GI-PIPES1', '½', 2, '2025-05-15', 0, '2025-05-15 07:28:24');
...
(10095, 'GI-PIPES1', '260.00', 'GI-PIPES', '22', '½', 'uploads/pr5.jpg', 'STEEL'),
(10096, 'GI-PIPES2', '360.00', 'GI-PIPES', '14', '¾', 'uploads/pr5.jpg', 'STEEL'),
(10097, 'GI-PIPES3', '480.00', 'GI-PIPES', '12', '1', 'uploads/pr5.jpg', 'STEEL'),
...
(10147, 'ANGLE BAR11', '460', 'ANGLE BAR', '14', '2', 'uploads/1742605649_23.-SS-ANGLE-BAR.jpg', 'STEEL');
...
(348, 'Joseph Dela Cruz', 'GI-PIPES3', '1', '2025-05-07', 'Pending', '1', NULL, 0.00),
(349, 'Joseph Dela Cruz', 'ANGLE BAR11', '1', '2025-05-07', 'Pending', '2', NULL, 0.00);
...
--
ALTER TABLE `tb_deleted_orders`
  MODIFY `order_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=351;

--
-- AUTO_INCREMENT for table `tb_inventory`
--
ALTER TABLE `tb_inventory`
  MODIFY `product_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10169;
