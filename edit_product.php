...
<body>
    ...
    <form method="POST" action="edit_product.php?product_id=<?php echo $product_id; ?>">
        ...
        <input type="text" name="category" id="category" value="<?php echo htmlspecialchars($product['category']); ?>" required oninput="convertToUpperCase()">
    ...
    <script>
        ...
        categoryInput.value = categoryInput.value.toUpperCase();
    }
    </script>
</body>
</html>
